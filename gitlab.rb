...
gitlab_rails['gitlab_email_from'] = 'root@akarpovich.com'
...
letsencrypt['contact_emails'] = ['alexsure.k@gmail.com'] # This should be an array of email addresses to add as contacts
